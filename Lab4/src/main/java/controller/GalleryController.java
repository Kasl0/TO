...
public class GalleryController {
    ...
    public void searchButtonClicked(ActionEvent event) {
        ...
        galleryModel.clear();
        photoDownloader.searchForPhotos(searchTextField.getText()).subscribeOn(Schedulers.io()).observeOn(JavaFxScheduler.platform()).subscribe(photo -> {
            galleryModel.addPhoto(photo);
        }, Throwable::printStackTrace, () -> progressIndicator.setVisible(false));
    }
}
