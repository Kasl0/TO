...
public class AccountOverviewController {
	...
	private void handleDeleteAction(ActionEvent event) {
		ArrayList<Transaction> transactionsToDelete = new ArrayList<>(transactionsTable.getSelectionModel().getSelectedItems());
		RemoveTransactionsCommand removeTransactionCommand = new RemoveTransactionsCommand(transactionsToDelete, data);
